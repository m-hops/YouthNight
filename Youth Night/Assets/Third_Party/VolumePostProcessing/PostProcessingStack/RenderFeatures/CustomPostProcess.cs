...
namespace izzynab.CustomPostProcessingStack
{
    ...
    public class CustomPostProcess : ScriptableRendererFeature
    {
        ...
        public class CustomPostProcessSettings
        {
            ...
            /// </summary>
            [SerializeField]
            public List<string> renderersAfterOpaque, renderersBeforePostProcess, renderersAfterPostProcess;

            public CustomPostProcessSettings()
            {
                renderersAfterOpaque = new List<string>();
        ...
        /// </summary>
        private CustomPostProcessRenderPass m_AfterOpaque, m_BeforePostProcess, m_AfterPostProcess;
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            if (renderingData.cameraData.postProcessEnabled)
            {
                ...
                if (m_AfterOpaque.HasPostProcessRenderers && m_AfterOpaque.PrepareRenderers(ref renderingData))
                {
                    m_AfterOpaque.Setup(renderer.cameraColorTarget, renderer.cameraColorTarget);
                    renderer.EnqueuePass(m_AfterOpaque);
                }
        ...
        public override void Create()
        {
            ...
            m_AfterOpaque = new CustomPostProcessRenderPass(CustomPostProcessInjectionPoint.AfterOpaque, InstantiateRenderers(settings.renderersAfterOpaque, shared));
    ...
    public class CustomPostProcessRenderPass : ScriptableRenderPass
    {
        ...
        public CustomPostProcessRenderPass(CustomPostProcessInjectionPoint injectionPoint, List<CustomPostProcessRenderer> renderers)
        {
            ...
            {
                case CustomPostProcessInjectionPoint.AfterOpaque:
                    renderPassEvent = RenderPassEvent.AfterRenderingOpaques;
                    m_PassName = "Custom PostProcess after Opaque";
                    break;
